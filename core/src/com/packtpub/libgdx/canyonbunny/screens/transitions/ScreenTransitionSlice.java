...
public class ScreenTransitionSlice implements ScreenTransition {
    ...
    @Override public void render (SpriteBatch batch, Texture currScreen,
        ...
        for (int i = 0; i < sliceIndex.size; i++) {
            ...
            x = i *sliceWidth;
            //vertical displacement using randomized list of slide indices
            ...
            batch.draw(nextScreen, x, y, 0, 0, sliceWidth, h, 1, 1,
                    0, i * sliceWidth, 0, sliceWidth, nextScreen.getHeight(),
                    false, true);
        }
        batch.end();
    }
